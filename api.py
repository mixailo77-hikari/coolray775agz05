...
def get_db_connection():
    try:
        ...
        print("DB Connection Error:", traceback.format_exc())
...
def save_data(payload: dict):
    try:
        ...
        print("Error in /api/save:", traceback.format_exc())
...
def load_data():
    try:
        ...
        print("Error in /api/load:", traceback.format_exc())
        raise HTTPException(status_code=500, detail=str(e))
...
def save_car_data(payload: dict):
    try:
        ...
        print("Error in /api/car-data POST:", traceback.format_exc())
        raise HTTPException(status_code=500, detail=str(e))
